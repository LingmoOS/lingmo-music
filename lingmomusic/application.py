...
from lingmomusic.about import show_about
from lingmomusic.coregrilo import CoreGrilo
from lingmomusic.coremodel import CoreModel
from lingmomusic.coreselection import CoreSelection
from lingmomusic.inhibitsuspend import InhibitSuspend
from lingmomusic.mpris import MPRIS
from lingmomusic.musiclogger import MusicLogger
from lingmomusic.notificationmanager import NotificationManager
from lingmomusic.pauseonsuspend import PauseOnSuspend
from lingmomusic.player import Player
from lingmomusic.scrobbler import LastFmScrobbler
from lingmomusic.search import Search
from lingmomusic.widgets.lastfmdialog import LastfmDialog
from lingmomusic.window import Window
...
class Application(Adw.Application):
    ...
    def __init__(self, application_id, version):
        ...
        self.props.resource_base_path = "/org/lingmo/Music"
        ...
        self._settings = Gio.Settings.new('org.lingmo.Music')
    ...
    def _help(self, action: Gio.Action, param: Optional[GLib.Variant]) -> None:
        ...
        Gtk.show_uri_full(
            self._window, "help:lingmo-music", Gdk.CURRENT_TIME, None,
            show_uri_cb)
    ...
    def do_activate(self):
        if not self._window:
            ...
            if self.props.application_id == "org.lingmo.Music.Devel":
