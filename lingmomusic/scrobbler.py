# Copyright (c) 2018 The Lingmo Music Developers
#
...
class GoaLastFM(GObject.GObject):
    ...
    def _new_client_callback(self, source, result):
        ...
        if manager is None:
            self._log.info("Lingmo Online Accounts is unavailable")
            return
    ...
    def _get_dbus_connection(
        ...
        try:
            proxy = Gio.DBusProxy.new_sync(
                ...
                "org.lingmo.Settings", "/org/lingmo/Settings", "org.gtk.Actions",
                None)
        except GLib.Error as e:
        ...
        try:
            ...
            if try_fallback:
                proxy = Gio.DBusProxy.new_sync(
                    self._connection, Gio.DBusProxyFlags.DO_NOT_CONNECT_SIGNALS
                    | Gio.DBusProxyFlags.DO_NOT_LOAD_PROPERTIES, None,
                    "org.lingmo.ControlCenter", "/org/lingmo/ControlCenter",
