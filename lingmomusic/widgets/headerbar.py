...
from lingmomusic.widgets.appmenu import AppMenu


@Gtk.Template(resource_path="/org/lingmo/Music/ui/SelectionBarMenuButton.ui")
...
@Gtk.Template(resource_path="/org/lingmo/Music/ui/HeaderBar.ui")
